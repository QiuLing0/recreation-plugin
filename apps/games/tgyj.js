...
export async function tgyj(e) {
  ...
  if (num1 > num2) {
    e.reply(`由于你是发起者,所以你将加伤20％,因此你受到${num1}点伤害,对方受到${num2}点伤害,恭喜你惩罚加倍！`)
    e.group.muteMember(qq2, num1 * 2);
    e.group.muteMember(qq, num2);
  } else if (num1 < num2) {
    e.reply(`由于你是发起者,所以你将加伤20％,因此你受到${num1}点伤害,对方受到${num2}点伤害,恭喜你惩罚减少！`)
    e.group.muteMember(qq2, num1);
    e.group.muteMember(qq, num2 * 2);
  } else {
    e.reply(`由于你是发起者,所以你将加伤20％,因此你受到${num1}点伤害,对方受到${num2}点伤害,恭喜你们惩罚一样！`)
    e.group.muteMember(qq2, num1);
    e.group.muteMember(qq, num2);
  }
